const products = [
  {
    ...
    pins: 1,
    category: "Soket",
    description: "Abarth, Alfa Romeo, Chevrolet, Citroën, Peugeot, Daewoo, Fiat, Ford, General Motors, Innocenti, Iveco, Jeep, Lancia, Opel, Saab, Suzuki ve Vauxhall araçlarla uyumlu yağ basınç müşür soketi.",
    image: "/images/KRD1001.png"
  },
  {
    id: 2,
    name: "Kızdırma (Isıtma) Buji Soketi",
    code: "KRD1001E",
    pins: 1,
    category: "Soket",
    description: "Alfa Romeo, Alpina, Audi, BMW, Chrysler, Citroën, Dacia, Fiat, Ford, Iveco, Jeep, Jaguar, Lada, Lancia, Land Rover, Maserati, Mercedes-Benz, Mini, Opel, Peugeot, Porsche, Renault, Rover, Saab, Suzuki, Seat, Skoda, Smart, Vauxhall, Volvo ve Volkswagen araçlarla uyumlu kızdırma bujisi soketi.",
